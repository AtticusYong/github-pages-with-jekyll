...
We will stay at home till our sisters get better from the vaccine. I like climbing mountains a lot. Here is some more code which is Node.js ->
// OLD JVASCRIPT

console.log('start');
// callback <==> run when we get back the information.
function getData(data, callback) {
  // setTimeout <==> run after a certain amount of seconds.
  setTimeout(() => {
...
// function will execute/run after x number of seconds.
getData(5, function(data) {
// console.log(x) is the same as print() in python.
  console.log(data);
});
...
here are all my repls, from replit.com https://replit.com/repls
